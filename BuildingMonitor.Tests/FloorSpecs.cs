...
{
    public class FloorSpecs : TestKit
    {
        [Fact]
        public void RegisterNewTemperatureSensorsWhenDoesNotAlreadyExists()
        {
        ...
        [Fact]
        public void ReturnEmptyListOfTemperatureSensorIdsIfNotExists()
        {
            var probe = CreateTestProbe();
            var floor = Sys.ActorOf(Floor.Props("a"));
